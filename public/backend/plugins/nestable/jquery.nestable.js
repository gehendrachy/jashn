...
(function ($, window, document, undefined) {
        ...
        dragMove: function (e) {
            ...
            if (!mouse.dirAx || isNewRoot || isEmpty) {
                ...
                if (isEmpty) {
                    ...
                    if (
                        !this.dragRootEl.find(
                            opt.itemNodeName + ", ." + opt.emptyClass
                        ).length
                    ) {
    ...
    Plugin.prototype.dragAutoScroll = function (
        event,
        scrollParent,
        overflowOffset
    ) {
        ...
        if (scrollParent[0] != document && scrollParent[0].tagName != "HTML") {
            if (!o.axis || o.axis != "x") {
                ...
                if (
                    ...
                    scrollParent[0].scrollTop =
                        scrollParent[0].scrollTop + o.scrollSpeed;
                    if (o.scrollRepeat)
                        dragTimerY = setTimeout(function () {
                            self.dragAutoScroll(
                                event,
                                scrollParent,
                                overflowOffset
                    ...
                    event.pageY - overflowOffset.top <
                    o.scrollSensitivity
                ) {
                    scrollParent[0].scrollTop =
                        scrollParent[0].scrollTop - o.scrollSpeed;
            ...
            if (!o.axis || o.axis != "y") {
                ...
                if (
                    overflowOffset.left +
                        scrollParent[0].offsetWidth -
                        event.pageX <
                    o.scrollSensitivity
                ) {
                    scrollParent[0].scrollLeft =
                        scrollParent[0].scrollLeft + o.scrollSpeed;
                    if (o.scrollRepeat)
                        dragTimerX = setTimeout(function () {
                            self.dragAutoScroll(
                                event,
                                scrollParent,
                                overflowOffset
                    ...
                    event.pageX - overflowOffset.left <
                    o.scrollSensitivity
                ) {
                    scrollParent[0].scrollLeft =
                        scrollParent[0].scrollLeft - o.scrollSpeed;
    ...
    Plugin.prototype.getScrollParent = function (element) {
        ...
        if (
            (isIe && /(static|relative)/.test(element.css("position"))) ||
        ...
        return /fixed/.test(element.css("position")) || !scrollParent.length
            ? $(document)
            : scrollParent;
    };
