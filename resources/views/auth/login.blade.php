...
<form method="POST" action="{{ route('securelogin') }}">
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="email" class="@if ($errors->has('email')) is-invalid @endif form-control" name="email" value="{{ old('email') }}" required autofocus id="loginEmail" maxlength="254" />
...
<div class="image-container">
    <div class="img-rush">
        <a href="{{ route('home') }}">
            <img src="{{ asset('storage/setting/logo/'.$setting->logo) }}" style="max-width: 55px;" alt="{{ $setting->title }}">
        </a>
    </div>
    <div class="img-cty">
        <a href="https://ktmrush.com">
