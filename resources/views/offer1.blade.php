...
@push('meta')
    <meta name="title" content="{{ $setting->meta_title }} - {{ $occassion->title }}">
    <meta name="description" content="{{ $setting->meta_description }}">
    <meta name="og:title" content="{{ $setting->og_title }} - {{ $occassion->title }}">
	                ...
	                <div class="col-sm-8">
	                    ...
	                    <div class="page-list">
	                        <ul class="breadcrumb">
	                            ...
	                            <li><a href="{{ route('occassion',['slug' => $occassion->slug]) }}">{{ $occassion->title }} /</a></li>
	                            <li>Products</li>
	                        </ul>
	                    </div>
	                </div>
	    ...
	    <div class="product-home product-list pt40 pb40">
	        <div class="container">
	        	@php
	        	    ...
	        	    $url_attributes['occassion_id'] = $occassion->id;
	        	    // dd($url_attributes);
	        	@endphp
		            ...
		            <div class="row">
		                ...
		                <div class="col-lg-9">
		                    ...
		                    {{-- <div class="row">
		                        <div class="col-md-12">
		                            @if(isset($_GET['sort']))
		                            {{ $product_size_variations->appends(['sort' => $_GET['sort']])->links() }}
		                            @else
		                            {{ $product_size_variations->links() }}
		                            @endif
		                        </div>
		                    </div> --}}
