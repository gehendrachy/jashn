            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Countries</h5>
                            <span>Create, Update, Delete Countries</span>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">List Countries</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route('admin.countries.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card border border-secondary">
                        <div class="card-header bg-default">
                            <h3>Drag & Drop to sort the Countries</h3>
                        </div>
                                                    ...
                                                    <td>
                                                        @if($country->id != 1)
                                                            <span class="content-right">
                                                                ...
                                                                <a href="{{ route('admin.countries.edit', base64_encode($country->id)) }}" class="btn btn-outline-primary" title="Edit"><i class="fa fa-edit"></i></a>
                                                                ...
                                                                <a href="#delete"
                                                                   ...
                                                                   onclick="delete_info_page('{{ base64_encode($country->id) }}')"><i class="fa fa-trash  "></i>
                                                               </a>
                                                            </span>
                                                        @endif
                                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="demoModalLabel">Are you sure, you want to delete Country?</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <p>Deleting this Country will delete all States, Districts and Cities with it?</p>
                </div>
