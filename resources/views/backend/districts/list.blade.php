            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Districts</h5>
                            <span>Create, Update, Delete Districts</span>
                ...
                <form method="POST" action="{{ route('admin.districts.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card border border-secondary">
                        <div class="card-header bg-default">
                            <h3>Drag & Drop to sort the districts</h3>
                        </div>
                                        ...
                                        <table id="info-pages-table" class="table table-striped table-bordered nowrap" style="margin-left: 0px; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $state = App\Models\State::where('id',$district->state_id)->first();
                                                        @endphp
                                                        {{ $state->name }}
                                                    ...
                                                    <td>
                                                        <span class="content-right">
                                                            ...
                                                            <a href="{{ route('admin.districts.edit', base64_encode($district->id)) }}" class="btn btn-outline-primary" title="Edit"><i class="fa fa-edit"></i></a>
                                                            ...
                                                            <a href="#delete"
                                                               ...
                                                               onclick="del_district('{{ base64_encode($district->id) }}')"><i class="fa fa-trash  "></i>
                                                           </a>
                                                        </span>
                                                    </td>
                                                </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="demoModalLabel">{{ __('Delete District')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                <p>Are you sure, you want to delete District?</p>
                </div>
