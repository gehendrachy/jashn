            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Couriers</h5>
                            <span>Create, Update, Delete Couriers</span>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">List Couriers</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route('admin.couriers.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card border border-secondary">
                        <div class="card-header bg-default">
                            <h3>Drag & Drop to sort the Couriers</h3>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="content-right">
                                                            ...
                                                            <a href="{{ route('admin.couriers.edit', base64_encode($courier->id)) }}" class="btn btn-outline-primary" title="Edit"><i class="fa fa-edit"></i></a>
                                                            
                                                            <a href="#delete"
                                                               data-toggle="modal"
                                                               data-id="{{ $courier->id }}"
                                                               id="delete{{ $courier->id }}"
                                                               title="Delete" 
                                                               class="btn btn-outline-danger center-block"
                                                               onclick="delete_info_page('{{ base64_encode($courier->id) }}')"><i class="fa fa-trash  "></i>
                                                           </a>
                                                        </span>
                                                    </td>
                                                </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="demoModalLabel">{{ __('Delete Courier')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                <p>Are you sure, you want to delete Courier?</p>
                </div>
