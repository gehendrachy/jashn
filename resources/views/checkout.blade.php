...
@section('content')
    ...
    <div class="container">
        <div class="checkout-wrapper pt40 pb40">
            <form action="{{ route('checkout-save-details') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="row" id="ship-box-info" style="display: inline-flex;">
                            ...
                            <div class="mb-2 col-sm-6">
                                ...
                                <input type="email" name="shipping_email" placeholder="E-Mail" id="input-shipping-email" class="form-control shipping-address-status" value="{{ old('shipping_email') ? old('shipping_email') : (isset($shipping_details->email) ? $shipping_details->email : '') }}" required>
                            </div>
                            <div class="mb-2 col-sm-6">
                            ...
                            <div class="mb-2 col-sm-6">
                                ...
                                <input type="text" name="shipping_street_address_1" value="{{ old('shipping_street_address_1') ? old('shipping_street_address_1') : (isset($shipping_details->street_address_1) ? $shipping_details->street_address_1 : '') }}" placeholder="Eg: Maitri Tole" id="input-shipping-street-address-1" class="form-control shipping-address-status" required>
                            </div>
                            <div class="mb-2 col-sm-6">
                                <label class="control-label" for="input-shipping-street-address-2">Street Address 2</label>
                                <input type="text" name="shipping_street_address_2" value="{{ old('shipping_street_address_2') ? old('shipping_street_address_2') : (isset($shipping_details->street_address_2) ? $shipping_details->street_address_2 : '') }}" placeholder="Eg: Maitri Tole" id="input-shipping-street-address-2" class="form-control shipping-address-status">
                            </div>
                        </div>
                        
                        <input name="same_address" value="1" id="ship-box" type="checkbox" {{ old('same_address') == 1 ? 'checked' : ( Auth::check() ? (isset($shipping_address) ? 'checked' : '') : 'checked') }}>
                        <label for="ship-box">
                        ...
                        <div class="row" id="billing-box-info">
                            ...
                            <div class="mb-2 col-sm-6">
                                ...
                                <input type="email" name="billing_email" placeholder="E-Mail" id="input-billing-email" class="form-control billing-address-status req-not-req" value="{{ old('billing_email') ? old('billing_email') : (isset($billing_details->email) ? $billing_details->email : '') }}" required>
                            </div>
                            <div class="mb-2 col-sm-6">
                    ...
                    <div class="col-sm-4">
                        <div class="checkout-cart">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right coupon-details" style="display: {{ isset($coupon_details['title']) ? '' : 'none' }}">
                                ...
                                <div class="col-6 text-right">
                                    ...
                                    <p>+ <strong>Nrs. <span id="shippingCost">0</span></strong></p>
                                </div>
                                <hr>
                                <div class="col-6">
                                    <p>Grand Total</p>
                                ...
                                <input type="hidden" name="offer_price" value="{{ $cart_total_offer_price }}">
                                <input type="hidden" name="shipping_cost">
                                <div class="col-12">
                                    <button id="placeOrder" type="submit" class="main-button colored">Next</button>
                                </div>
                            </div>
                        </div>
