...
@push('meta')
    <meta name="title" content="{{ $setting->meta_title }} - {{ $offer->name }}">
    <meta name="description" content="{{ $setting->meta_description }}">
    <meta name="og:title" content="{{ $setting->og_title }} - {{ $offer->name }}">
	                ...
	                <div class="col-sm-8">
	                    ...
	                    <div class="page-list">
	                        <ul class="breadcrumb">
	                            ...
	                            <li><a href="{{ route('offer',['slug' => $offer->slug]) }}">{{ $offer->name }} /</a></li>
	                            <li>Products</li>
	                        </ul>
	                    </div>
	                </div>
	    ...
	    <div class="product-home product-list pt40 pb40">
	        <div class="container">
	        	@php
	        	    ...
	        	    $url_attributes['offer_id'] = $offer->id;
	        	    // dd($url_attributes);
	        	@endphp
