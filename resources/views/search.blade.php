                        ...
                        @if($product_size_variations->count() > 0)
                            <?php
                                ...
                                function generate_url($filter_key, $ignore_id = 0, $add_id = 'not-set'){
                                    ...
                                    $parametersArray['search'] = $_GET['search'];
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <h3 class="main-title mb16"><span>Search Results</span></h3>
                                </div>
                            ...
                            <div class="row">
                                        ...
                                        @foreach($filter_delivery_times as $key => $delivery_time)
                                            <li>
                                                <a href="{{ isset($_GET['delivery_time']) && in_array($delivery_time, $_GET['delivery_time']) ? generate_url('delivery_time', $delivery_time) : generate_url('delivery_time', 'not-set', $delivery_time) }}">
                                                    ...
                                                    {{ $delivery_time == 1 ? 'Pre - Order' : 'In Stock' }}
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
                                ...
                                <div class="col-lg-9">
                                                ...
                                                <div class="display-style">
                                                    ...
                                                    @if(count($_GET) > 1)
                                                        <div class="inner-flex" style="margin-right: 20px;">
                                                            <a href="{{ url()->current().'?search='.Request::get('search') }}"><small>Clear All Filter <i class="fa fa-times-circle"></i></small> </a>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div id="myDropdown" class="dropdown-content">
                                                            ...
                                                            {{-- <a href="{{ (isset($_GET['sort']) && 'alphaAZ' == $_GET['sort']) ? generate_url('sort', 'alphaAZ') : generate_url('sort', 'not-set', 'alphaAZ') }}" <?=Request::get('sort') == 'alphaAZ' ? 'selected' : '' ?>>Name (A - Z)</a> --}}
                                                        ...
                                                        <div class="product-details">
                                                            <div class="seen-product-details">
                                                                <div>
                                                                    ...
                                                                    {{-- <p>
                                                                        @foreach($product_color->product->fabrics as $fabric)
                                                                            <small>{{ $fabric->title }}</small><br>
                                                                        @endforeach
                                                                    </p> --}}
                                    ...
                                    {{-- <div class="row">
                                        <div class="col-md-12">
                                            @if(isset($_GET['sort']))
                                            {{ $product_size_variations->appends(['search' => $_GET['search'], 'sort' => $_GET['sort']])->links() }}
                                            @else
                                            {{ $product_size_variations->appends(['search' => $_GET['search']])->links() }}
                                            @endif
                                        </div>
                                    </div> --}}
                                </div>
